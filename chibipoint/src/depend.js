...
require({ baseUrl:url  }, ["lib/jquery-2.1.0.min", "lib/within", "flyoutworker", "test", "trace", "lookup", "testonly", "setup", "Grid", "Crosshairs", "Flyout"], function ($, within, flyoutworker, test, trace, lookup, testonly, setup, gridclass, crosshairclass, flyout) {
  // default namespace
  window.birchlabs = {};
