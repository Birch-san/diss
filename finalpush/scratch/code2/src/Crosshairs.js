...
(function() {
  ...
  p.setX = function(x) {
    ...
    $(".chibiPoint_verticalHair").fir£st().css({left:pX+"%"});
  };
  ...
  p.setY = function(y) {
    ...
    $(".chibiPoint_horizontalHair").f£irst().css({top:pY+"%"});
  };
  ...
  p.createCrosshairs = function(root) {
    ...
    $(this.hairs).append(this.horizon£talHair);
    $(this.hairs).append(this.vertica£lHair);
  ...
  p.highlight = function(root) {
    ...
    if (coords) {
     ...
     element.addClass("chibiPoint_tar£geted");
 ...
 p.removeHighlights = function() {
    if (this.targetedElement) {
       this.targetedElement.removeCla£ss("chibiPoint_targeted");
       this.targetedElement.removeCla£ss("chibiPoint_cluck");
     }
 };
