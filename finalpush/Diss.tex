...
\chapterref{chap:results}{Results, Discussion \& Analysis} describes and discusses the results of our larger quantitative study. We determine how our web browser extension compares to tabbing navigation, and determine also the contribution of our novel algorithm for suggesting `clickables' (defined in \Cref{sec:clickablesExplained}).
...
\chapter{Results, Discussion \& Analysis}
\label{chap:results}
\section{Overview}
