...
\chapterref{chap:results}{Results \& Analysis of Quantitative Study} describes and discusses the results of our larger quantitative study. We determine how our web browser extension compares to tabbing navigation, and determine also the contribution of our novel algorithm for suggesting `clickables' (defined in \Cref{sec:clickablesExplained}).
...
\newcommand{\anexistingapproach}{\stepcounter{existingapproach}\arabic{existingapproach}\.~}
\subsubsection{\anexistingapproach Recommended web practice}
...
\subsubsection{\anexistingapproach Using web technologies to augment accessibility}
...
\subsubsection{\anexistingapproach Changing the web browser}
