...
That is: the viewport of the browser is divided into a grid, and each cell assigned a keyboard shortcut. The user specifies by keypress which cell contains the element they are interested in. Then a new, smaller grid is constructed within that cell, and the process repeats itself.
...
Though MouseGrid itself is not novel, 
