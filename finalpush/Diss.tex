...
For speed comparisons, we will not invest in a formal significance analysis. We will consider a difference as relevant where means and their error bars are lower than those of another bar. `Comparable' performance is considered when error bars overlap.
